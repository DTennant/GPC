...
get_dataset_funcs = {
    ...
    'cifar100_ucd': get_cifar_100_ucd_datasets,
    'imagenet_100': get_imagenet_100_datasets,
    'imagenet_100_ucd': get_imagenet_ucd_100_datasets,
    'imagenet_100_ncd': get_imagenet_ucd_100_datasets,
    'herbarium_19': get_herbarium_datasets,
    'cub': get_cub_datasets,
    'cub_ucd': get_cub_universal_datasets,
    'aircraft': get_aircraft_datasets,
    'scars': get_scars_datasets,
    'inat_mini': get_inat_universal_datasets,
    'domainnet': get_domainnet_universal_datasets,
    'color_symbol': get_color_symbol_universal_datasets,
}


customize_datasets = ['inat_mini', 'cifar100_ucd', 'cub_ucd', 'domainnet', 'imagenet_100_ucd', 'imagenet_100_ncd', 'color_symbol']
...
def get_datasets(dataset_name, train_transform, test_transform, args):
    ...
    if dataset_name not in customize_datasets: 
        ...
        datasets = get_dataset_f(train_transform=train_transform, test_transform=test_transform,
                                ...
                                prop_train_labels=args.prop_train_labels,
                                split_train_val=False)
    elif dataset_name == 'imagenet_100_ucd':
        datasets = get_dataset_f(train_transform=train_transform, test_transform=test_transform,
                                labelled_classes=args.train_classes,
                                unlabelled_classes=args.unlabeled_classes,
                                prop_train_labels=args.prop_train_labels,
                                split_train_val=False)
    elif dataset_name == 'imagenet_100_ncd':
        datasets = get_dataset_f(train_transform=train_transform, test_transform=test_transform,
                                labelled_classes=args.train_classes,
                                unlabelled_classes=args.unlabeled_classes,
                                prop_train_labels=args.prop_train_labels,
                                split_train_val=False)
    elif dataset_name == 'color_symbol': 
        datasets = get_dataset_f(train_transform=train_transform, test_transform=test_transform,
                                labelled_classes=args.train_classes,
                                unlabelled_classes=args.unlabeled_classes,
                                prop_train_labels=args.prop_train_labels,
    ...
    for i, cls in enumerate(sorted(list(set(args.train_classes) | set(args.unlabeled_classes)))):
        target_transform_dict[cls] = i
    target_transform = lambda x: target_transform_dict[x]

    # __import__("ipdb").set_trace()
    args.num_cluster = len(set.union(set(args.unlabeled_classes), set(args.train_classes)))
...
def get_class_splits(args):
    ...
    if args.dataset_name in ('scars', 'cub', 'cub_ucd', 'aircraft'):
    ...
    elif args.dataset_name == 'cifar100_ucd':

        args.image_size = 32
        args.train_classes = range(50)
        args.unlabeled_classes = range(25, 100)
            ...
            # args.unlabeled_classes += args.train_classes[len(args.train_classes)//2:]
        args.labeled_classes_not_in_unlabeled = args.train_classes[:len(args.train_classes)//2]
        args.labeled_classes_in_unlabeled = args.train_classes[len(args.train_classes)//2:]
    ...
    elif args.dataset_name == 'imagenet_100_ucd':
    ...
    elif args.dataset_name == 'imagenet_100_ncd':

        args.image_size = 224
        args.train_classes = range(50)
        args.unlabeled_classes = range(50, 100)
        args.labeled_classes_not_in_unlabeled = args.train_classes[:len(args.train_classes)]
        args.labeled_classes_in_unlabeled = args.train_classes[len(args.train_classes):]
    ...
    elif args.dataset_name == 'cub_ucd':

        args.image_size = 224

        args.train_classes = range(100)
        args.unlabeled_classes = range(50, 200)
        if use_ssb_splits:
            split_path = os.path.join(osr_split_dir, 'cub_osr_splits.pkl')
            with open(split_path, 'rb') as handle:
                class_info = pickle.load(handle)
    ...
    elif args.dataset_name == 'inat_mini':

        args.image_size = 224
        args.train_classes = range(5000)
        args.unlabeled_classes = range(2500, 10000)
        
    elif args.dataset_name == 'domainnet': 
        args.image_size = 224
        args.train_classes = range(171)
        args.unlabeled_classes = range(90, 345)
        
    elif args.dataset_name == 'color_symbol':
        args.image_size = 128
        args.train_classes = [0,1,2,5,6]
        args.unlabeled_classes = [2,3,4,6,7,8,9]
