...
from randaugment import ImageNetPolicy, CIFAR10Policy
...
def get_transform(transform_type='default', image_size=32, args=None):
    ...
    if transform_type == 'imagenet':
        ...
        train_transform = transforms.Compose([
            ...
            transforms.RandomCrop(image_size),
            # transforms.RandomHorizontalFlip(p=0.5),
            transforms.RandomAffine(degrees=10, translate=(0.1, 0.1), scale=(0.9, 1.1), shear=5, resample=False, fillcolor=0),
            transforms.ColorJitter(),
            transforms.ToTensor(),
            transforms.Normalize(
                mean=torch.tensor(mean),
    ...
    if args.use_strong_aug:
        ...
        return train_transform, test_transform, strong_transform
